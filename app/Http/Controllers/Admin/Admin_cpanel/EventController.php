...
class EventController extends Controller
{
    ...
    public function eventAdd(Request $request){
        ...
        $resizeImagePage 	    = $this->resizeEventSaveDir().$imageUniqueName;
        $originalImagePath 	    = $this->originalEventSaveDir().$imageUniqueName;
        ...
        //$originalImagePath 	= $this->originalEventSaveDir();
