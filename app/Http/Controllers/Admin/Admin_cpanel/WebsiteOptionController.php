...
{   
    ...
    public function companyAdd(Request $request){
        ...
        $uploadPath 	    = 'frontendStyle/img/company/'.$imageUniqueName;
    ...
    public function sliderAdd(Request $request){
        ...
        //Image Unique Name
        $imageUniqueName    = Str::random(40).'.'.$extension;
        $uploadPath 	    = 'frontendStyle/img/slider/'.$imageUniqueName;
    ...
    public function chairmanMessageUpdate(Request $request){
        ...
        if($request->hasFile('image')) {
            ...
            $uploadPath 	     = 'frontendStyle/img/chairman/'.$imageUniqueName;
