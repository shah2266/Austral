...
class EmployeeController extends Controller
{
    ...
    public function employeeAdd(Request $request){
        ...
        $uploadPath 	        = $this->resizeEmployeeSaveDir().$imageUniqueName;
        $originalImagePath 	    = $this->originalEmployeeSaveDir().$imageUniqueName;
        ...
        //$originalImagePath 	= $this->originalEmployeeSaveDir();
