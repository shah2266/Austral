...
<div class="box box-success">
    ...
    <div class="box-body">
        <form action="{{ url('/controlpanel/admin/event/add') }}" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group has-feedback {{ $errors->has('from_date') ? ' has-error':'' }} ">
                                        ...
                                        <input type="text" name="from_date" class="form-control pull-right {{ $errors->has('from_date') ? ' has-error':'' }}" value="{{ old('from_date') }}" placeholder="From date" id="datepicker">
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group has-feedback {{ $errors->has('to_date') ? ' has-error':'' }} ">
                                        ...
                                        <input type="text" name="to_date" class="form-control pull-right {{ $errors->has('to_date') ? ' has-error':'' }}" value="{{ old('to_date') }}" placeholder="To date" id="datepicker2">
                                        </div>
