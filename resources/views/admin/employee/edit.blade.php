...
<div class="box box-success">
    ...
    <div class="box-body">
        <form action="{{ url('/controlpanel/admin/employee/edit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-xs-4">
                    <div class="form-group {{ $errors->has('image') ? ' has-error':'' }}">
                        ...
                        <img src="{{ asset($employee->resize_image_path.$employee->image) }}" alt="" class="image__resize">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group has-feedback {{ $errors->has('name') ? ' has-error':'' }}">
                                <input type="text" class="form-control {{ $errors->has('name') ? ' has-error':'' }} "
                                    id="name" name="name" value="{{ $employee->name }}" placeholder="name">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="id_card" name="id_card" value="{{ $employee->id_card }}"
                                            placeholder="Card no">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="contact" name="contact" value="{{ $employee->contact }}"
                                            placeholder="contact">
                                        <span class="fa fa-link form-control-feedback"></span>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group has-feedback {{ $errors->has('address') ? ' has-error':'' }}">
                                        <input type="text" class="form-control {{ $errors->has('address') ? ' has-error':'' }} "
                                            id="address" name="address" value="{{ $employee->address }}" placeholder="Address">
                                        <span class="fa fa-map-marker form-control-feedback"></span>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group {{ $errors->has('gender') ? ' has-error':'' }}">
                                        ...
                                        <select class="form-control select2 {{ $errors->has('gender') ? ' has-error':'' }}" name="gender" style="width: 100%;">
                                            ...
                                            @foreach($gender as $key => $st)
                                                <option value="{{ $key }}" {{ ($employee->gender == $key)? 'selected':''}} >{{ $st }}</option>
                                            @endforeach                                   
                                        </select>
            ...
            <div class="row">
                    ...
                    <div class="form-group {{ $errors->has('status') ? ' has-error':'' }}">
                        ...
                        <select class="form-control select2" name="status" style="width: 100%;">
                            @foreach($status as $key => $st)
                                <option value="{{ $key }}" {{ ($employee->status == $key)? 'selected':''}} >{{ $st }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group {{ $errors->has('description') ? ' has-error':'' }}">
                        <textarea id="editor1" name="description" rows="10" cols="80">{{ $employee->description }}</textarea>
