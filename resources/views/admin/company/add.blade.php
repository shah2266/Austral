...
<div class="box box-success">
    <div class="box-header with-border">
        <h3 class="box-title">Company Add Section</h3>
    ...
    <div class="box-body">
        <form action="{{ url('/controlpanel/admin/company/add') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-lg-12">
                            <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error':'' }}">
                                <input type="text" class="form-control {{ $errors->has('email') ? ' has-error':'' }} "
                                    id="email" name="email" value="{{ old('email') }}" placeholder="Company Email">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group has-feedback {{ $errors->has('phone') ? ' has-error':'' }}">
                                <input type="text" class="form-control {{ $errors->has('phone') ? ' has-error':'' }} "
                                    id="phone" name="phone" value="{{ old('phone') }}" placeholder="Contact Number">
                                <span class="fa fa-phone form-control-feedback"></span>
                                @if ($errors->has('phone'))
                                <span class="help-block" role="alert">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group has-feedback {{ $errors->has('telephone') ? ' has-error':'' }}">
                                <input type="text" class="form-control {{ $errors->has('telephone') ? ' has-error':'' }} "
                                    id="telephone" name="telephone" value="{{ old('telephone') }}" placeholder="Telephone Number">
                                <span class="fa fa-phone form-control-feedback"></span>
                        ...
                        <div class="col-lg-12">
                            <div
                                ...
                                <input type="text"
                                    ...
                                    id="copy_right_text" name="copy_right_text" value="{{ old('copy_right_text') }}"
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('social_link_icon_1') }}" placeholder="Icon 1">
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="social_link1" name="social_link1" value="{{ old('social_link1') }}"
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('social_link_icon_2') }}" placeholder="Icon 2">
                                        <span class="fa fa-plus-square-o form-control-feedback"></span>
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="social_link2" name="social_link2" value="{{ old('social_link2') }}"
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('social_link_icon_3') }}" placeholder="Icon 3">
                                        <span class="fa fa-plus-square-o form-control-feedback"></span>
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="social_link3" name="social_link3" value="{{ old('social_link3') }}"
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('social_link_icon_4') }}" placeholder="Icon 4">
                                        <span class="fa fa-plus-square-o form-control-feedback"></span>
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="social_link4" name="social_link4" value="{{ old('social_link4') }}"
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('social_link_icon_5') }}" placeholder="Icon 5">
                                        <span class="fa fa-plus-square-o form-control-feedback"></span>
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="social_link5" name="social_link5" value="{{ old('social_link5') }}"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group has-feedback {{ $errors->has('latitude') ? ' has-error':'' }}">
                        <input type="text" class="form-control {{ $errors->has('latitude') ? ' has-error':'' }} "
                            id="latitude" name="latitude" value="{{ old('latitude') }}" placeholder="Latitude">
                        <span class="fa fa-map-marker form-control-feedback"></span>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group has-feedback {{ $errors->has('longitude') ? ' has-error':'' }}">
                        <input type="text" class="form-control {{ $errors->has('longitude') ? ' has-error':'' }} "
                            id="longitude" name="longitude" value="{{ old('longitude') }}" placeholder="Longitude">
                        <span class="fa fa-map-marker form-control-feedback"></span>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group has-feedback {{ $errors->has('map_content') ? ' has-error':'' }}">
                        <input type="text" class="form-control {{ $errors->has('map_content') ? ' has-error':'' }} "
                            id="map_content" name="map_content" value="{{ old('map_content') }}"
