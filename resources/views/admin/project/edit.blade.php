...
<div class="box box-success">
    ...
    <div class="box-body">
        <form action="{{ url('/controlpanel/admin/project/edit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group {{ $errors->has('image') ? ' has-error':'' }}">
                        ...
                        <img src="{{ asset($project->resize_image_path.$project->image) }}" alt="" class="image__resize">
                        <input type="file" name="image" class="file" value="{{ $project->image }}">
                            ...
                            <div class="form-group {{ $errors->has('project_type') ? ' has-error':'' }}">
                                ...
                                <select class="form-control select2 {{ $errors->has('project_type') ? ' has-error':'' }}" name="project_type" style="width: 100%;">
                                    ...
                                    @foreach($types as $key => $type)
                                        <option value="{{ $key }}" {{ ($project->project_type == $key)? 'selected':''}}>{{ $type }}</option>
                                    @endforeach                                    
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group has-feedback {{ $errors->has('project_name') ? ' has-error':'' }}">
                                <input type="text"
                                    ...
                                    id="project_name" name="project_name" value="{{ $project->project_name }}"
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $project->total_area }}" placeholder="Total area">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div
                                        ...
                                        <select class="form-control select2 {{ $errors->has('number_of_unit') ? ' has-error':'' }}" name="number_of_unit" style="width: 100%;">
                                            ...
                                            @for($i = 1; $i <= 20; $i++)
                                                <option value="{{ $i }}" {{ ($project->number_of_unit == $i)? 'selected':''}}>{{ $i }}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $project->parking_space }}" placeholder="Parking space">
                                        <span class="fa fa-plus-square-o form-control-feedback"></span>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="features" name="features" value="{{ $project->features }}"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group has-feedback {{ $errors->has('address') ? ' has-error':'' }}">
                                <input type="text" class="form-control {{ $errors->has('address') ? ' has-error':'' }} "
                                    id="address" name="address" value="{{ $project->address }}" placeholder="Address">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div
                                        ...
                                        <input type="text"
                                            ...
                                            id="flat" name="flat"
                                            value="{{ $project->flat }}" placeholder="Total number of flat">
                                        <span class="fa fa-plus-square-o form-control-feedback"></span>
                                        @if ($errors->has('flat'))
                                        <span class="help-block" role="alert">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group {{ $errors->has('lift') ? ' has-error':'' }}">
                                        <select class="form-control select2" name="lift" style="width: 100%;">
                                            ...
                                            @for($i = 1; $i <= 20; $i++)
                                                <option value="{{ $i }}" {{($project->lift == $i)? 'selected':''}}>{{ $i }}</option>
                                            @endfor
                                        </select>
                                        @if ($errors->has('lift'))
                                        <span class="help-block" role="alert">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <div class="form-group has-feedback {{ $errors->has('handover_date_time') ? ' has-error':'' }} ">
                                        ...
                                        <input type="text" name="handover_date_time" class="form-control pull-right {{ $errors->has('handover_date_time') ? ' has-error':'' }}" value="{{ $project->handover_date_time }}" placeholder="Pick handover date" id="datepicker">
                                        </div>
                    ...
                    <div class="form-group {{ $errors->has('status') ? ' has-error':'' }}">
                        ...
                        <select class="form-control select2" name="status" style="width: 100%;">
                            @foreach($status as $key => $st)
                                <option value="{{ $key }}" {{ ($project->status == $key)? 'selected':''}} >{{ $st }}</option>
                            @endforeach
                        </select>
