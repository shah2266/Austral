    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Add project diagram</h3>
            ...
            <div class="box-body">
                <form action="{{ url('/controlpanel/admin/project/diagram/add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box box-warning">
            <div class="box-header with-border">
                <h3 class="box-title">Project diagram list</h3>

                <div class="box-tools pull-right">
                    <span data-toggle="tooltip" title="{{ count($diagrams) }} Info Found"
                        class="badge bg-yellow">{{ count($diagrams) }}</span>
                            ...
                            <div class="margin">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                        <li>
                                            <a href="{{ url('/controlpanel/admin/project/'.$data->project_id.'/diagram/publish/'.$data->id) }}"><i
                                                    class="fa fa-eye"></i> Publish this info</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/controlpanel/admin/project/'.$data->project_id.'/diagram/unpublished/'.$data->id) }}"><i
                                                    class="fa fa-eye-slash"></i> Unpublished this info</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/controlpanel/admin/project/'.$data->project_id.'/diagram/delete/'.$data->id) }}"><i
